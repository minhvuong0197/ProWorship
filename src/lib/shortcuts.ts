...
// Order of library/tool modes (Ctrl+1..9, Ctrl+0) — mirrors src/lib/nav.ts MODE_ORDER.
export const MODES_ORDER = [
  "songs",
  "bible",
  "media",
  "audio",
