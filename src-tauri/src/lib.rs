...
.unwrap_or_else(|e| {
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::native::ndi_output_start,
            ...
            commands::output::open_extra_output_window,
            commands::output::close_output_window,
            commands::output::close_output_window_by_label,
            commands::output::list_output_windows,
