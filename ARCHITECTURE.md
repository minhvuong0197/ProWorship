...
| 2026-09-05 | **Diagnostics export**: health indicator trên Toolbar mở report gồm user agent, trạng thái Output/Stage/NDI, monitor đích, nội dung live và 50 lỗi gần nhất; report có thể tải thành file `.txt` để hỗ trợ vận hành. |
